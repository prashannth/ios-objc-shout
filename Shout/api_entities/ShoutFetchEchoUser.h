...
@interface ShoutFetchEchoUser : NSObject{
...
@protocol ShoutFetchEchoUserProtocol <NSObject>

-(void)completionHandlerShoutFetchEchoUser:(ShoutFetchEchoUser *)fetchShoutEchoUserObject;
