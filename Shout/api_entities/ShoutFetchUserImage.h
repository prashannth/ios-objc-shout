...
@interface ShoutFetchUserImage : NSObject{
...
@protocol ShoutFetchUserImageProtocol <NSObject>

-(void)completionHandlerShoutFetchUserImage:(ShoutFetchUserImage *)fetchShoutUserImageObject;
