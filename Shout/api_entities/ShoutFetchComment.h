...
@interface ShoutFetchComment : NSObject{
...
@protocol ShoutFetchCommentProtocol <NSObject>

-(void)completionHandlerShoutFetchComment:(ShoutFetchComment *)fetchShoutCommentObject;
