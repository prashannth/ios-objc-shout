...
@interface ShoutMuteUser : NSObject{
...
@property (retain, nonatomic) NSString *muteUserId;
...
@protocol ShoutMuteUserProtocol <NSObject>

-(void)completionHandlerShoutMuteUser:(ShoutMuteUser *)muteShoutUserObject;
