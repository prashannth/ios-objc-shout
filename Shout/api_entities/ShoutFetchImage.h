...
@interface ShoutFetchImage : NSObject{
...
@protocol ShoutFetchImageProtocol <NSObject>

-(void)completionHandlerShoutFetchImage:(ShoutFetchImage *)fetchShoutImageObject;
