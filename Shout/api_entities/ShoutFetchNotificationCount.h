...
@interface ShoutFetchNotificationCount : NSObject{
...
@protocol ShoutFetchNotificationCountProtocol <NSObject>

-(void)completionHandlerShoutFetchNotificationCount:(ShoutFetchNotificationCount *)fetchShoutNotificationCountObject;
