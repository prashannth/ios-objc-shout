...
#import "ShoutAppDelegate.h"
#import "ShoutFeedTableViewController.h"

@implementation ShoutAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    vController = [[ShoutFeedTableViewController alloc] initWithNibName:@"ShoutFeedTableViewController" bundle:nil];
